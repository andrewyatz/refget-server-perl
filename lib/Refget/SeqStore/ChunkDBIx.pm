...
package Refget::SeqStore::ChunkedDBIx;
...
# Default chunk power makes chunks of size 134,217,728 characters
has 'chunk_power' => (isa => 'Int', is => 'ro', required => 1, default => 27);

sub _store {
  my ($self, $checksum, $sequence) = @_;
  my $rs = $self->schema->resultset('ChunkedRawSeq');
  return undef;
